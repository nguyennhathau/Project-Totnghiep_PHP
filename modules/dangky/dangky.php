...
<form id="frmdangky" name="frmdangky"  method="post" onsubmit="return frmdangkyform()">
  <table width="80%" height="181" border="1" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
  <td>Họ tên: </td>
      <td><label><input name="hoten" type="text" id="hoten"></label></td></tr>
	 <tr>
		<td>Địa chỉ: </td>
		<td><label><input name="diachi" type="text" id="diachi"></label></td></tr>
	 <tr>
		<td>Email: </td>
	 ...
	 <tr>
		<td>Điện thoại: </td>
		<td><label><input name="dienthoai" type="text" id="dienthoai"></label></td>
    </tr>
    <tr>
		<td>&nbsp;</td>
		<td><label><input name="dangky" type="submit" id="dangky" value="Đăng ký"></label></td>
    </tr>
  </table>
</form>
